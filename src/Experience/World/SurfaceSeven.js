...
import vertexShader from '../shaders/7/vertex_7.glsl'
import fragmentShader from '../shaders/7/fragment_7.glsl'

export default class SurfaceSeven {
  constructor() {
  ...
  setMesh() {
    ...
    this.mesh.position.set(120, 30, 0);
